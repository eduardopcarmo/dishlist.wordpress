<?php
/**
 * Dishlist functions and definitions
 *
...
if ( ! function_exists( 'dishlist_setup' ) ) :
	/**
	...
	function dishlist_setup() {
		 ...
		 * If you're building a theme based on Dishlist, use a find and replace
		 * to change 'dishlist' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'dishlist', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'dishlist_custom_background_args', array(
 ...
 */
function dishlist_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'dishlist_content_width', 640 );
}
add_action( 'after_setup_theme', 'dishlist_content_width', 0 );
 ...
 */
function dishlist_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'dishlist' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'dishlist' ),
...
add_action( 'widgets_init', 'dishlist_widgets_init' );
